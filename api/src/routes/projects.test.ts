...
vi.mock('../db/client.js', () => ({
  ...
  queryRow: async (sql: string, params: unknown[]) => {
    const result = await mockPoolQuery(sql, params);
...
describe('Projects API', () => {
  ...
  describe('GET /api/projects', () => {
    it('returns array with ice_score computed field', async () => {
      ...
      mockPoolQuery.mockResolvedValueOnce({ rows: mockProjects } as any);
  ...
  describe('GET /api/projects/:id', () => {
    it('returns project with ice_score computed', async () => {
      ...
      mockPoolQuery.mockResolvedValueOnce({ rows: [mockProject] } as any);
